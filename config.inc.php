...
$HELPDESK_SUPPORT_EMAIL_ID = 'sysadmin@redoo-networks.com';
...
$site_URL = (!empty($_SERVER['HTTPS']) ? 'https' : 'http').'://' . $_SERVER['HTTP_HOST'].dirname($_SERVER['SCRIPT_NAME']).'/';
...
$application_unique_key = 'c1203a09eb4200b31bce8571b8d8d7ce';
